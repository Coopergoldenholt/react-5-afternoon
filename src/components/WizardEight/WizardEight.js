					...
					<div className="row">
						<Link to="/wNine">
							<button
								...
								onClick={e => this.props.updateHistory("No History")}
							>
								No
							</button>
						</Link>
						<Link to="/wNine">
							<button
								...
								onClick={e => this.props.updateHistory("Bankruptcy")}
							>
								Bankruptcy
							</button>
						</Link>
						<Link to="/wNine">
							<button
								...
								onClick={e => this.props.updateHistory("Foreclosure")}
							>
								Foreclosure
							</button>
						</Link>
						<Link to="/wNine">
							<button
								...
								onClick={e =>
									this.props.updateHistory("Bankruptcy and Foreclosure")
								}
							>
								Both
							</button>
